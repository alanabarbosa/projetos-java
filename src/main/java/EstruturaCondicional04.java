...
/**
 * Estrutura Concidiconal - Calculadora IMC simples
 * 
...
public class EstruturaCondicional04 {
    public static void main(String[] args) {
        ...
        if (calcIMC < 18.5) {
            System.out.println("Seu IMC é de: " + calcIMC);
            System.out.println("Atenção!! " + name + " Seu peso está abaixo do normal!!!");
            System.out.println("Procure um médico. Algumas pessoas têm um baixo peso por características do seu organismo e tudo bem. Outras podem estar enfrentando problemas, como desnutrição. É preciso saber qual é o caso");
            ...
            System.out.println("Sinal de alerta! Chegou a hora de se cuidar, mesmo que seus exames estejam normais. Vamos dar início a mudanças hoje! Cuide de sua alimentação. Você precisa iniciar um acompanhamento com nutricionista e/ou endocrinologista.");
